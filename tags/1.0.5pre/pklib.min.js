/** pklib JavaScript library v1.0.5pre | http://pklib.com/licencja.html **/

(function(global){"use strict";global.pklib={author:"Piotr Kowalski",www:"http://pklib.com/",version:"1.0.5pre"};}(this));if(typeof Function.prototype.bind!=="function"){Function.prototype.bind=function(that){"use strict";var method=this,slice=Array.prototype.slice,args=slice.apply(arguments,[1]);return function(){return method.apply(that,args.concat(slice.apply(arguments,[0])));};};}
